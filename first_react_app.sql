...
--
-- Host: 127.0.0.1
-- Generation Time: May 03, 2021 at 08:48 PM
...
(1, 'Web Development', 'I build native and cross platfrom mobile app for your business app for your business', 'http://localhost:3000/static/media/project.79ae680b.jpg', 'Web Development', 'Web Development', 'Web Development', 'Web Development', 'Web Development', 'Web Development', 'Web Development'),
(2, 'Web Development', 'I build native and cross platfrom mobile app for your business app for your business', 'http://localhost:3000/static/media/project.79ae680b.jpg', 'Web Development', 'Web Development', 'Web Development', 'Web Developmen', 'Web Development', 'Web Development', 'Web Development'),
(3, 'Web Development', 'I build native and cross platfrom mobile app for your business app for your business', 'http://localhost:3000/static/media/project.79ae680b.jpg', 'Web Development', 'Web Development', 'Web Development', 'Web Developmen', 'Web Development', 'Web Development', 'Web Development'),
(4, 'Web Development', 'I build native and cross platfrom mobile app for your business app for your business', 'http://localhost:3000/static/media/project.79ae680b.jpg', 'Web Development', 'Web Development', 'Web Development', 'Web Development', 'Web Development', 'Web Development', 'Web Development'),
(5, 'Web Development', 'I build native and cross platfrom mobile app for your business app for your business', 'http://localhost:3000/static/media/project.79ae680b.jpg', 'Web Development', 'Web Development', 'Web Development', 'Web Developmen', 'Web Development', 'Web Development', 'Web Development'),
(6, 'Web Development', 'I build native and cross platfrom mobile app for your business app for your business', 'http://localhost:3000/static/media/project.79ae680b.jpg', 'Web Development', 'Web Development', 'Web Development', 'Web Developmen', 'Web Development', 'Web Development', 'Web Development');
...
(1, 'http://localhost:3000/static/media/project.79ae680b.jpg', 'http://localhost:3000/static/media/project.79ae680b.jpg', 'Foll Bazzar 1', 'Complete e-commerce app solution for selling fruit online. According to build quality, data loading speed this is the best one ', 'To build native android apps i use Java as well as kotline mainly. React JS is used for cross platform mobile application. I use MySQL database for relational database system. To build NoSQL application i use MongoDB. Firebase database system is used where it is necessary to provide realtime data flow facilities. ', 'http://rabbil.com/'),
...
(3, 'http://localhost:3000/static/media/project.79ae680b.jpg\r\n', 'http://localhost:3000/static/media/project.79ae680b.jpg', 'Foll Bazzar 3', 'Complete e-commerce app solution for selling fruit online. According to build quality, data loading speed this is the best one ', 'To build native android apps i use Java as well as kotline mainly. React JS is used for cross platform mobile application. I use MySQL database for relational database system. To build NoSQL application i use MongoDB. Firebase database system is used where it is necessary to provide realtime data flow facilities. ', 'http://rabbil.com/'),
(4, 'http://localhost:3000/static/media/project.79ae680b.jpg', 'http://localhost:3000/static/media/project.79ae680b.jpg', 'Foll Bazzar ', 'Complete e-commerce app solution for selling fruit online. According to build quality, data loading speed this is the best one ', 'To build native android apps i use Java as well as kotline mainly. React JS is used for cross platform mobile application. I use MySQL database for relational database system. To build NoSQL application i use MongoDB. Firebase database system is used where it is necessary to provide realtime data flow facilities. ', 'http://rabbil.com/'),
(5, 'http://localhost:3000/static/media/project.79ae680b.jpg', 'http://localhost:3000/static/media/project.79ae680b.jpg', 'Foll Bazzar ', 'Complete e-commerce app solution for selling fruit online. According to build quality, data loading speed this is the best one ', 'To build native android apps i use Java as well as kotline mainly. React JS is used for cross platform mobile application. I use MySQL database for relational database system. To build NoSQL application i use MongoDB. Firebase database system is used where it is necessary to provide realtime data flow facilities. ', 'http://rabbil.com/');
